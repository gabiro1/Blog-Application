...
function LoginModal({ isOpen, onClose, onSwitchToRegister }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black bg-opacity-40 backdrop-blur-sm flex items-center justify-center">
      <div ref={modalRef} className="bg-white rounded-xl p-6 w-full max-w-md shadow-2xl relative animate-fade-in">
  ...
  onClick={() => {
    ...
    if (typeof onSwitchToRegister === 'function') {
      ...
      console.warn("onSwitchToRegister is not defined or not a function");
    }
  }}
>
  Register Now
