...
function Footer() {
  return (
    <footer className="bg-[#0E552D] text-white py-10 px-5">
      <div className="max-w-7xl mx-auto flex flex-wrap justify-between gap-10 text-left">
        ...
        <div className="flex-1 min-w-[250px] flex flex-col gap-4">
          ...
          <div className="flex items-center gap-2 text-white px-4 py-1 rounded-lg hover:bg-green-600 hover:text-white transition cursor-pointer w-fit">
            <p className="font-medium mt-1">Contact our support team</p>
